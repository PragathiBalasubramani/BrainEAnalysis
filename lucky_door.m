function [EEG_clean, fig, rejTrials, statsinfo] = lucky_door(EEGmain, tabledata, flag_save, flag_alignment)
...
elseif flag == 5 %Coin Tally feedback onset
